var MedicalInsurancesController = ['$scope', '$window', '$state', 'MedicalCompanies', 'MedicalCompany',
    'MedicalInsurancePlans', 'MedicalInsurancePlan',
    function ($scope, $window, $state, MedicalCompanies, MedicalCompany, MedicalInsurancePlans, MedicalInsurancePlan) {
...
var MedicalCompanyDetailsController = ['$scope', '$rootScope', '$stateParams', 'MedicalCompany',
    function ($scope, $rootScope, $stateParams, MedicalCompany) {
...
var AddMedicalCompanyController = ['$scope', '$rootScope', '$stateParams', 'MedicalCompany',
    function ($scope, $rootScope, $stateParams, MedicalCompany) {
