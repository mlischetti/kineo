...
public class GoogleCalendarService implements CalendarService {
    ...
    @Value("${kinesio.calendar.calendarId}")
    private String calendarId;

    @Value("${kinesio.calendar.serviceAccountId}")
    private String serviceAccountId;

    @Value("${kinesio.calendar.keyFilePath}")
    private String keyFilePath;

    @Value("${kinesio.calendar.applicationName}")
    private String applicationName = "kinesio-test-server";
