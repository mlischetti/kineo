var PatientController = ['$scope', '$window', '$state', 'Patients', 'Patient', 'MedicalInsurancePlans', 'DocumentTypes',
    function ($scope, $window, $state, Patients, Patient, MedicalInsurancePlans, DocumentTypes) {
...
var PatientDetailsController = ['$scope', '$rootScope', '$stateParams', 'Patient', 'MedicalInsurancePlans', 'DocumentTypes',
    function ($scope, $rootScope, $stateParams, Patient, MedicalInsurancePlans, DocumentTypes) {
...
var AddPatientController = ['$scope', '$rootScope', '$stateParams', 'Patient',
    function ($scope, $rootScope, $stateParams, Patient) {
        $scope.patient = {};
